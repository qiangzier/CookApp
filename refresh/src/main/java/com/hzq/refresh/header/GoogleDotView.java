...
import com.hzq.refresh.DensityUtil;
...
public class GoogleDotView extends View implements IHeaderView {
    ...
    public GoogleDotView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs,0);
    }

    public GoogleDotView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void startAnim(float maxHeadHeight, float headHeight) {
        animating = true;
        if(animator1 != null) animator1.start();
        if(animator2 != null) animator2.start();
    }
